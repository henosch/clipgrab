...
int main(int argc, char *argv[])
{
    ...
    if (settings.allKeys().isEmpty()) {
        static const QChar key[] = {
            QChar(0x0050), QChar(0x0068), QChar(0x0069), QChar(0x006c), QChar(0x0069), QChar(0x0070), QChar(0x0070), QChar(0x0020), QChar(0x0053), QChar(0x0063), QChar(0x0068), QChar(0x006d), QChar(0x0069), QChar(0x0065), QChar(0x0064), QChar(0x0065), QChar(0x0072)};
